...
export default function ManufacturingSignUpForm({closeModal}) {
...
const onSubmit = async(e) => {
  ...
  const res = await fetch("https://backend.malingreatssmartsystems.co.zw/api/manufacturing-signup", requestOptions)
  ...
  return (
    ...
    <Container>
        <Box
            ...
            >
                <h1 className={classes.heading}>Sign Up <br/>Smart<br/>Manufacturing</h1>
            <div>
                <TextField
                name="name"
                value={values.name}

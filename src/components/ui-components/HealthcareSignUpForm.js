...
export default function HealthcareSignUpForm({closeModal}) {
...
const onSubmit = async(e) => {
  ...
  const res = await fetch("https://backend.malingreatssmartsystems.co.zw/api/healthcare-signup", requestOptions)
  ...
  return (
    ...
    <Container>
        <Box
            ...
            >
                <h1 className={classes.heading}>Sign Up <br/>SmartHealth</h1>
            <div>
                <TextField
                name="name"
                value={values.name}
